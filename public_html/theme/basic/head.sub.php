...
<meta name="twitter:card" id="t_card" content="<?php echo $seo['title']?>">
<meta name="twitter:title" id="t_title" content="<?php echo $seo['title']?>">
<meta name="twitter:description" id="t_description" content="<?php echo $seo['description']?>">
<meta name="twitter:image" id="t_image" content="<?php echo $seo['image']?>">
<meta name="twitter:domain" id="t_domain" content="<?php echo $seo['url']?>">
<?php
if (G5_IS_MOBILE) {
...
<link rel="canonical" href="http://innobox.co.kr/bbs/board.php?bo_table=portfolio">
...
<script src="<?php echo G5_JS_URL ?>/jquery-ui-1.11.4.min.js"></script>
