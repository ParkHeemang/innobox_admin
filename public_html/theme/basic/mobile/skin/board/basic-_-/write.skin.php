...
<?php
    ...
    if ($bo_table == 'notice' || $bo_table == 'reservation' || $bo_table == 'cscenter' ) {
        ...
        echo '<li><a href="'.G5_BBS_URL.'/board.php?bo_table=cscenter">견적상담</a></li>';
        echo '</ul>';
        echo '</div>';
    }
...
<div id="bbs" class="bbs_<?php echo $bo_table; ?>">
    <section id="bo_w">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <?php } ?>
            <?php if ($bo_table == 'cscenter') { ?>
            <tr>
                <th scope="row"><label for="wr_1">회사명<strong class="sound_only">필수</strong></label></th>
            ...
            <tr>
                ...
                <td><input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" required class="frm_input required"></td>
            </tr>
            <?php } ?>
            <tr>
