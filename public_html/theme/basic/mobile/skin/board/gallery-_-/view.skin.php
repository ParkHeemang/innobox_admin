...
<div id="cost_wrap">
    <div id="cost">
        ...
        <a href="tel:010-2738-3653" id="tel">전화문의: 010-2738-3653</a>
        <a href="http://pf.kakao.com/_VxmxiTC" target="_blank" id="img42"><img src="<?php echo G5_THEME_IMG_URL?>/m_kakao.png"></a>
        ...
        <div id="bo_v_con">
			<div class="bo_info">
                <div class="bo_v_expand">
                    ...
                    <div class="bo_nav">
                        <ul>
                            <?php if ($prev_href) { ?><li><a href="<?php echo $prev_href ?>"><img src="<?php echo G5_THEME_IMG_URL?>/view_prev.png"></a></li><?php } ?>
                            <li><a href="<?php echo $list_href ?>"><img src="<?php echo G5_THEME_IMG_URL?>/view_list.png"></a></li>
                            <?php if ($next_href) { ?><li><a href="<?php echo $next_href ?>"><img src="<?php echo G5_THEME_IMG_URL?>/view_next.png"></a></li><?php } ?>
                        </ul>
                    </div>
                </div>
                <table>
