...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="3">
                <input type="text" name="wr_10" value="<?php echo $write['wr_10'] ?>" id="wr_10" class="frm_input required" required size="50" placeholder="주소" onKeyDown="if(event.keyCode==13){codeAddress();}"> 
                ...
                -->
                <a href="#none" class="btn_submit2 btn" onclick="codeAddress()">검색</a>
            </td>
        </tr>
        <tr>
