...
add_stylesheet('<link rel="stylesheet" href="'. G5_TAGEDITOR_URL .'/jquery.tag-editor.css">', 1);

//add_javascript('<script src="https://code.jquery.com/ui/1.10.2/jquery-ui.min.js"></script>', 1);
add_javascript('<script src="'.G5_TAGEDITOR_URL.'/jquery.caret.min.js"></script>', 2);
add_javascript('<script src="'.G5_TAGEDITOR_URL.'/jquery.tag-editor.js"></script>', 3);
...
<section id="bo_w">
    ...
    <input type="hidden" name="wr_tag" id="wr_tag" value="<?php echo $write['wr_2'] ?>">
    <?php
    $option = '';
    $option_hidden = '';
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td>
				<div id="autosave_wrapper">
					<input type="text" name="wr_1" value="<?=$write['wr_1']?>" id="wr_1" class="frm_input required frm_inputWidth" size="50">
				</div>
			</td>
		</tr>
		<?php endif?>
		...
		<tr>
			...
			<td>
        <div style="padding :0 7px 0 0px;max-width:900px;">
            <textarea id="wr_2"><?php echo $write['wr_2']?></textarea>
				</div>
			</td>
		</tr>
		<?php endif?>
		...
		<tr>
			...
			<td>
				<div id="autosave_wrapper">
					<input type="text" name="wr_3" value="<?=$write['wr_3']?>" id="wr_3" class="frm_input required frm_inputWidth" size="50">
				</div>
			</td>
		</tr>
		<?php endif?>
        ...
        <tr>
            <th scope="row"><label for="wr_link<?php echo $i ?>">링크 #</label></th>
    ...
    function fwrite_submit(f)
    {
        ...
        <?php echo $captcha_js; // 캡챠 사용시 자바스크립트에서 입력된 캡챠를 검사함  ?>
				...
				var tags = $('#wr_2').tagEditor('getTags')[0].tags;
