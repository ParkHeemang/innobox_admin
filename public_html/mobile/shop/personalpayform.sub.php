...
// 테마에 personalpayform.sub.php 있으면 include
if(defined('G5_THEME_MSHOP_PATH')) {
    $theme_personalpayform_file = G5_THEME_MSHOP_PATH.'/personalpayform.sub.php';
    if(is_file($theme_personalpayform_file)) {
        include_once($theme_personalpayform_file);
        return;
        unset($theme_personalpayform_file);
    }
}
