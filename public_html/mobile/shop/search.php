...
// 테마에 search.php 있으면 include
if(defined('G5_THEME_MSHOP_PATH')) {
    $theme_search_file = G5_THEME_MSHOP_PATH.'/search.php';
    if(is_file($theme_search_file)) {
        include_once($theme_search_file);
        return;
        unset($theme_search_file);
    }
}
