				...
				<div class="box" style="height:680px">
					<div class="box-body">
						<div class="local_ov01 local_ov">
							<strong>회원정보 최근 업데이트 : <?php echo $sms5['cf_datetime']?></strong>
						</div>
						...
						<div id="sms5_send">
							...
							<div id="send_write">
								...
								<div id="write_recv" class="write_inner">
									...
									<div id="recv_add">
										...
										<button type="button" onclick="hp_add()" class="btn btn-default">추가</button><br>
									</div>
								</div>

								<div id="write_rsv" class="write_inner">
									<h2><strong>예약전송</strong></h2>
							...
							<div id="send_book">
								<h2><strong>휴대폰번호 목록</strong></h2>
								<div id="book_tab">
									<a href="#book_group" id="book_group" class="btn btn-default">그룹</a>
									<a href="#book_person" id="book_person" class="btn btn-default">개인</a>
									<a href="#book_level" id="book_level" class="btn btn-default">권한</a>
								</div>
