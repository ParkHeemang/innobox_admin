					...
					<div class="box-header">
						<nav class="navbar navbar-default navbtn" style="z-index: 1000000000000000000000000000000000">
							<div class="text-right">							
								...
								<input type="submit" name="act_button" value="수신허용" onclick="document.pressed=this.value" class="btn btn-success">
								<input type="submit" name="act_button" value="수신거부" onclick="document.pressed=this.value" class="btn btn-warning">
...
<!---->
						...
						<input type="hidden" name="str_query" value="<?php echo clean_query_string($_SERVER['QUERY_STRING']); ?>" >
							...
							<tr>
								<th scope="col">
									...
									<input type="checkbox" id="example-select-all" onclick="book_all_checked(this.checked)">
								</th>
								<th scope="col">번호</th>
								<th scope="col">그룹</th>
								<th scope="col">이름</th>
						...
						<select name="bg_no" id="bg_no" onchange="location.href='<?php echo $_SERVER['SCRIPT_NAME']?>?bg_no='+this.value;" class="form-control">
