...
<table id="example1" class="table table-bordered table-striped dataTable member_list" width="100%">
	...
	<tr>
		...
		<td class="td_mngsmall"><button type="button" class="btn btn-primary" onclick="sms_obj.group_add(1, '<?php echo $no_group['bg_name']?>', '<?php echo number_format($no_group['bg_receipt'])?>')">추가</button></td>
	</tr>
	<?php
	$line = 1;
