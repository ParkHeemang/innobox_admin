...
<input type="text" name="sv" value="<?php echo $sv?>" id="sv" required class="form-control frm_input required sms_write" size="12">
</div>
<div class="text-right"><input type="submit" value="검색" class="btn btn-primary"></div>
</form>
