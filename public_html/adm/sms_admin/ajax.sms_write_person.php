...
?>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mngsmall"><button type="button" class="btn btn-primary" onclick="sms_obj.person_add(<?php echo $res['bk_no']?>, '<?php echo get_text($res['bk_name']) ?>', '<?php echo $res['bk_hp']?>')">추가</button></td>
    </tr>
    <?php } ?>
    </tbody>
    </table>
...
<div class="btn_list01 btn_list">
    <button type="button" onclick="sms_obj.person_multi_add()" class="btn btn-default">선택추가</button>
    <button type="button" onclick="sms_obj.triggerclick('#book_group')"  class="btn btn-default">그룹목록</button>
</div>
