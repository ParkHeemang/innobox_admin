			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<nav class="navbar navbar-default navbtn mb-nav" style="z-index: 1000000000000000000000000000000000">
							<div class="text-right">							
								<div class="btn_fixed_top">
									<a href="./couponlist.php" class="btn btn_02 btn-default">목록</a>
						...
						<form name="fcouponform" action="./couponformupdate.php" method="post" onsubmit="return form_check(this);">
							...
							<div class="tbl_frm01 tbl_wrap">
								...
								<tr>
									...
									<td>
										<input type="text" name="cp_subject" value="<?php echo stripslashes($cp['cp_subject']); ?>" id="cp_subject" required class="required frm_input form-control form-control" size="50">
									</td>
								</tr>
								<tr>
									...
									<td>
									   ...
									   <select name="cp_method" id="cp_method" class="form-control">
								...
								<tr id="tr_cp_target">
									...
									<td>
									   <input type="text" name="cp_target" value="<?php echo stripslashes($cp['cp_target']); ?>" id="cp_target" required class="required frm_input form-control">
									   <button type="button" id="sch_target" class="btn_frmline btn btn-default"><?php echo $cp_target_btn; ?></button>
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="mb_id">회원아이디</label></th>
									<td>
										<input type="text" name="mb_id" value="<?php echo stripslashes($cp['mb_id']); ?>" id="mb_id" class="frm_input form-control">
										<button type="button" id="sch_member" class="btn_frmline btn btn-default">회원검색</button>
								...
								<tr>
									...
									<td>
										...
										<input type="text" name="cp_start" value="<?php echo stripslashes($cp['cp_start']); ?>" id="cp_start" required class="frm_input form-control required">
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php echo help('입력 예: '.date('Y-m-d')); ?>
										<input type="text" name="cp_end" value="<?php echo stripslashes($cp['cp_end']); ?>" id="cp_end" required class="frm_input form-control required">
									</td>
								</tr>
								<tr>
									...
									<td>
									   ...
									   <select name="cp_type" id="cp_type" class="form-control">
								...
								<tr>
									...
									<td>
										<input type="text" name="cp_price" value="<?php echo stripslashes($cp['cp_price']); ?>" id="cp_price" required class="frm_input form-control required"> <span id="cp_price_unit"><?php echo $cp['cp_type'] ? '%' : '원'; ?></span>
									</td>
								</tr>
								<tr id="tr_cp_trunc">
								...
								<tr>
									...
									<td>
										<input type="text" name="cp_minimum" value="<?php echo stripslashes($cp['cp_minimum']); ?>" id="cp_minimum" class="frm_input form-control"> 원
									</td>
								</tr>
								<tr id="tr_cp_maximum">
									<th scope="row"><label for="cp_maximum">최대할인금액</label></th>
									<td>
										<input type="text" name="cp_maximum" value="<?php echo stripslashes($cp['cp_maximum']); ?>" id="cp_maximum" class="frm_input form-control"> 원
									</td>
								</tr>
								<?php if($w == '') { ?>
								<tr>
