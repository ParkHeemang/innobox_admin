					...
					<div class="box-header">
						<nav class="navbar navbar-default navbtn" style="z-index: 1000000000000000000000000000000000">
							<div class="text-right">							
								<a href="./couponzonelist.php?<?php echo $qstr; ?>" class="btn_02 btn btn-default">목록</a>
							...
							<table id="example2" class="table table-bordered table-hover dataTable member-form" role="grid" aria-describedby="example2_info">
								...
								<tr>
									...
									<td>
									   ...
									   <select name="cz_type" id="cz_type" class="form-control">
								...
								<tr>
									...
									<td>
										<input type="text" name="cz_subject" value="<?php echo get_text($cp['cz_subject']); ?>" id="cz_subject" required class="required frm_input form-control" size="50">
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<input type="text" name="cz_start" value="<?php echo stripslashes($cp['cz_start']); ?>" id="cz_start" required class="frm_input form-control required">
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php echo help('입력 예: '.date('Y-m-d')); ?>
										<input type="text" name="cz_end" value="<?php echo stripslashes($cp['cz_end']); ?>" id="cz_end" required class="frm_input form-control required">
									</td>
								</tr>
								<tr id="tr_cz_point">
									...
									<td>
										...
										<input type="text" name="cz_point" value="<?php echo get_text($cp['cz_point']); ?>" id="cz_point" class="frm_input form-control">
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<input type="text" name="cz_period" value="<?php echo stripslashes($cp['cz_period']); ?>" id="cz_period" required class="frm_input form-control required" size="5"> 일
									</td>
								</tr>
								<tr>
