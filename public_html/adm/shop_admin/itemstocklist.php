				...
				<div class="box">
					<div class="box-header">
						<nav class="navbar navbar-default navbtn" style="z-index: 1000000000000000000000000000000000">
							<div class="text-right">							
								<a href="./optionstocklist.php" class="btn btn-default btn_02">상품옵션재고</a>
								<a href="./itemsellrank.php"  class="btn btn-default btn_02">상품판매순위</a>
								<input type="submit" value="일괄수정" class="btn btn-danger btn_submit btn">					
							</div>
						</nav>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						...
						<form name="flist" class="local_sch01 local_sch">
							...
							<input type="text" name="search" id="search" value="<?php echo $search; ?>" required class="frm_input form-control required">
							...
							<div class="tbl_head01 tbl_wrap">
								...
								<tr class="<?php echo $bg; ?>">
									...
									<td class="td_num">
										...
										<input type="text" name="it_stock_qty[<?php echo $i; ?>]" value="<?php echo $row['it_stock_qty']; ?>" id="stock_qty_<?php echo $i; ?>" class="frm_input form-control" size="10" autocomplete="off">
									</td>
									<td class="td_num">
										<!-- <label for="noti_qty_<?php echo $i; ?>" class="sound_only">통보수량</label> -->
										<input type="text" name="it_noti_qty[<?php echo $i; ?>]" value="<?php echo $row['it_noti_qty']; ?>" id="noti_qty_<?php echo $i; ?>" class="frm_input form-control" size="10" autocomplete="off">
									</td>
									<td class="td_chk2">
									...
									<td class="td_mng td_mng_s"><a href="./itemform.php?w=u&amp;it_id=<?php echo $row['it_id']; ?>&amp;ca_id=<?php echo $row['ca_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn_03 btn-success">수정</a></td>
								</tr>
								<?php
								}
								if (!$i)
