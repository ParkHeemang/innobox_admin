		...
		<nav class="navbar navbar-default navbtn configform" style="z-index: 1000000000000000000000000000000000">
			<div class="nav-tabs-custom configform">
				<ul class="nav nav-tabs" id="tab_ul">                 
					<li class="active"><a href="#tab_1" data-toggle="tab">필수입력</a></li>
					<li><a href="#tab_2" data-toggle="tab">선택입력</a></li>
					<li><a href="#tab_3" data-toggle="tab">여분필드</a></li>
 
					<li class="pull-right config_form">
						<div>
							<a href="http://test.innobox.co.kr/shop/" class="btn btn_02 btn-default">쇼핑몰</a>
								...
								<table id="example2" class="table table-bordered table-hover dataTable configform">
									...
									<tr>
										...
										<?php if ($w == "") { ?>
											...
											<input type="text" name="ca_id" value="<?php echo $subid; ?>" id="ca_id" required class="required frm_input form-control" size="<?php echo $sublen; ?>" maxlength="<?php echo $sublen; ?>">
									...
									<tr>
										...
										<td><input type="text" name="ca_name" value="<?php echo $ca['ca_name']; ?>" id="ca_name" size="38" required class="required frm_input form-control"></td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="text" name="ca_order" value="<?php echo $ca['ca_order']; ?>" id="ca_order" class="frm_input form-control" size="12">
										</td>
									</tr>
									<tr>
										...
										<td>
											<?php if ($is_admin == 'super') { ?>
												<input type="text" name="ca_mb_id" value="<?php echo $ca['ca_mb_id']; ?>" id="ca_mb_id" class="frm_input form-control" maxlength="20">
											<?php } else { ?>
									...
									<tr>
										...
										<td>
											<?php echo get_skin_select('shop', 'ca_skin_dir', 'ca_skin_dir', $ca['ca_skin_dir'], 'class="form-control"'); ?>
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="ca_mobile_skin_dir">모바일용 스킨명</label></th>
										<td>
											<?php echo get_mobile_skin_select('shop', 'ca_mobile_skin_dir', 'ca_mobile_skin_dir', $ca['ca_mobile_skin_dir'], 'class="form-control"'); ?>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											...
											<select id="ca_skin" name="ca_skin" required class="required form-control">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="ca_img_width" value="<?php echo $ca['ca_img_width']; ?>" id="ca_img_width" required class="required frm_input form-control" size="5" > 픽셀
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="text" name="ca_img_height"  value="<?php echo $ca['ca_img_height']; ?>" id="ca_img_height" required class="required frm_input form-control" size="5" > 픽셀
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="text" name="ca_list_mod" size="3" value="<?php echo $ca['ca_list_mod']; ?>" id="ca_list_mod" required class="required frm_input form-control"> 개
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="text" name="ca_list_row" value='<?php echo $ca['ca_list_row']; ?>' id="ca_list_row" required class="required frm_input form-control" size="3"> 줄
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<select id="ca_mobile_skin" name="ca_mobile_skin" required class="required form-control">
									...
									<tr>
										...
										<td>
											<?php echo help("쇼핑몰환경설정 &gt; 이미지(소) 넓이가 기본값으로 설정됩니다.\n".G5_SHOP_URL."/list.php에서 출력되는 이미지의 폭입니다."); ?>
											<input type="text" name="ca_mobile_img_width" value="<?php echo $ca['ca_mobile_img_width']; ?>" id="ca_mobile_img_width" required class="required frm_input form-control" size="5" > 픽셀
										</td>
									</tr>
									<tr>
										...
										<td>
											<?php echo help("쇼핑몰환경설정 &gt; 이미지(소) 높이가 기본값으로 설정됩니다.\n".G5_SHOP_URL."/list.php에서 출력되는 이미지의 높이입니다."); ?>
											<input type="text" name="ca_mobile_img_height"  value="<?php echo $ca['ca_mobile_img_height']; ?>" id="ca_mobile_img_height" required class="required frm_input form-control" size="5" > 픽셀
										</td>
									</tr>
									<tr>
										...
										<td>
											<?php echo help("한 줄에 설정한 값만큼의 상품을 출력하지만 스킨에 따라 한 줄에 하나의 상품만 출력할 수도 있습니다."); ?>
											<input type="text" name="ca_mobile_list_mod" value='<?php echo $ca['ca_mobile_list_mod']; ?>' id="ca_mobile_list_mod" required class="required frm_input form-control" size="3"> 개
										</td>
									</tr>
									<tr>
										...
										<td>
											<?php echo help("한 페이지에 출력할 이미지 줄 수를 설정합니다.\n한 페이지에서 표시하는 상품수는 (1줄당 이미지 수 x 줄 수) 입니다."); ?>
											<input type="text" name="ca_mobile_list_row" value='<?php echo $ca['ca_mobile_list_row']; ?>' id="ca_mobile_list_row" required class="required frm_input form-control" size="3"> 줄
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="text" name="ca_stock_qty" size="10" value="<?php echo $ca['ca_stock_qty']; ?>" id="ca_stock_qty" class="frm_input form-control"> 개
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="text" name="ca_sell_email" size="40" value="<?php echo $ca['ca_sell_email']; ?>" id="ca_sell_email" class="frm_input form-control">
										</td>
									</tr>
									<tr>
								 ...
								 <table id="example2" class="table table-bordered table-hover dataTable configform">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="ca_include_head" value="<?php echo $ca['ca_include_head']; ?>" id="ca_include_head" class="frm_input form-control" size="60">
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="text" name="ca_include_tail" value="<?php echo $ca['ca_include_tail']; ?>" id="ca_include_tail" class="frm_input form-control" size="60">
										</td>
									</tr>
									<tr>
								...
								<table id="example2" class="table table-bordered table-hover dataTable configform">
									...
									<tr>
										...
										<td class="td_extra">
											...
											<input type="text" name="ca_<?php echo $i ?>_subj" id="ca_<?php echo $i ?>_subj" value="<?php echo get_text($ca['ca_'.$i.'_subj']) ?>" class="frm_input form-control">
											<label for="ca_<?php echo $i ?>">여분필드 <?php echo $i ?> 값</label>
											<input type="text" name="ca_<?php echo $i ?>" value="<?php echo get_text($ca['ca_'.$i]) ?>" id="ca_<?php echo $i ?>" class="frm_input form-control">
										</td>
									</tr>
									<?php } ?>
									</tbody>
