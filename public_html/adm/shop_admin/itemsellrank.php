			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<nav class="navbar navbar-default navbtn" style="z-index: 1000000000000000000000000000000000">
							<div class="text-right">							
								<a href="./itemstocklist.php" class="btn_02 btn btn-default">상품재고관리</a>
								<a href="./itemlist.php" class="btn_01 btn btn-primary">상품등록</a>						
							</div>
						</nav>
					</div>
					<!-- /.box-header -->
					<div class="box-body">							
						...
						<input type="text" name="fr_date" value="<?php echo $fr_date; ?>" id="fr_date" required class="required frm_input form-control" size="8" maxlength="8"> 에서
						<label for="to_date" class="sound_only">종료일</label>
						<input type="text" name="to_date" value="<?php echo $to_date; ?>" id="to_date" required class="required frm_input form-control" size="8" maxlength="8"> 까지
						<input type="submit" value="검색" class="btn_submit btn btn-defaultl">
