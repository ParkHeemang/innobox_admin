		...
		<nav class="navbar navbar-default navbtn configform" style="z-index: 1000000000000000000000000000000000">
			<div class="nav-tabs-custom configform">
				<ul class="nav nav-tabs" id="nav_ul">                 
					<li class="active"><a href="#tab_1" data-toggle="tab">상품분류</a></li>
					<li><a href="#tab_2" data-toggle="tab">스킨설정</a></li>
					<li><a href="#tab_3" data-toggle="tab">기본정보</a></li>
					<li><a href="#tab_4" data-toggle="tab">요약정보</a></li>
					<li><a href="#tab_5" data-toggle="tab">가격 및 재고</a></li>
					<li><a href="#tab_6" data-toggle="tab">배송비</a></li>
					<li><a href="#tab_7" data-toggle="tab">상품이미지</a></li>
					<li><a href="#tab_8" data-toggle="tab">관련상품</a></li>
					<li><a href="#tab_9" data-toggle="tab">관련이벤트</a></li>
					<li><a href="#tab_10" data-toggle="tab">상세설명설정</a></li>
					<li><a href="#tab_11" data-toggle="tab">여분필드</a></li>
 
					<li class="pull-right config_form">
						<div>
							<a href="./itemlist.php?<?php echo $qstr; ?>" class="btn btn_02 btn-default">목록</a>
							<a href="<?php echo G5_SHOP_URL ;?>/item.php?it_id=<?php echo $it_id ;?>" class="btn_02  btn btn-danger">상품보기</a>
						...
						<div class="tab-content">
								...
								<table id="example2" class="table table-bordered table-hover dataTable configform">
									...
									<tr>
										...
										<td>
											...
											<select name="ca_id" id="ca_id" onchange="categorychange(this.form)" class="form-control">
									...
									<tr>
										...
										<td>
											...
											<select name="ca_id<?php echo $i; ?>" id="ca_id<?php echo $i; ?>" class="form-control">
												<option value="">선택하세요</option>
								...
								<table id="example2" class="table table-bordered table-hover dataTable configform">
									...
									<tr>
										...
										<td colspan="2">
											<?php if ($w == '') { // 추가 ?>
												...
												<input type="text" name="it_id" value="<?php echo time(); ?>" id="it_id" required class="frm_input form-control required" size="20" maxlength="20">
											...
											<?php } else { ?>
												...
												<a href="<?php echo G5_SHOP_URL; ?>/item.php?it_id=<?php echo $it_id; ?>" class="btn_frmline btn btn-default">상품확인</a>
												<a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/itemuselist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline btn btn-default">사용후기</a>
												<a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/itemqalist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline btn btn-default">상품문의</a>
											<?php } ?>
										</td>
									</tr>
									<tr>
										...
										<td colspan="2">
											...
											<input type="text" name="it_name" value="<?php echo get_text(cut_str($it['it_name'], 250, "")); ?>" id="it_name" required class="frm_input form-control required" size="95">
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="text" name="it_basic" value="<?php echo get_text($it['it_basic']); ?>" id="it_basic" class="frm_input form-control" size="95">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="it_order" value="<?php echo $it['it_order']; ?>" id="it_order" class="frm_input form-control" size="12">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="it_maker" value="<?php echo get_text($it['it_maker']); ?>" id="it_maker" class="frm_input form-control" size="40">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											<?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
											<input type="text" name="it_origin" value="<?php echo get_text($it['it_origin']); ?>" id="it_origin" class="frm_input form-control" size="40">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											<?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
											<input type="text" name="it_brand" value="<?php echo get_text($it['it_brand']); ?>" id="it_brand" class="frm_input form-control" size="40">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											<?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
											<input type="text" name="it_model" value="<?php echo get_text($it['it_model']); ?>" id="it_model" class="frm_input form-control" size="40">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td colspan="2">
											...
											<input type="text" name="ec_mall_pid" value="<?php echo get_text($it['ec_mall_pid']); ?>" id="ec_mall_pid" class="frm_input form-control" size="20">
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="it_sell_email" value="<?php echo $it['it_sell_email']; ?>" id="it_sell_email" class="frm_input form-control" size="40">
										</td>
										<td class="td_grpset">
							...
							<div class="tab-pane" id="tab_4">
									...
									<div id="sit_compact">
										...
										<select id="it_info_gubun" name="it_info_gubun" class="form-control">
							...
							<div class="tab-pane" id="tab_5">
								...
								<table id="example2" class="table table-bordered table-hover dataTable configform">
										...
										<tr>
											...
											<td>
												<input type="text" name="it_price" value="<?php echo $it['it_price']; ?>" id="it_price" class="frm_input form-control" size="8"> 원
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												<?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
												<input type="text" name="it_cust_price" value="<?php echo $it['it_cust_price']; ?>" id="it_cust_price" class="frm_input form-control" size="8"> 원
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<select name="it_point_type" id="it_point_type" class="form-control">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="it_point" value="<?php echo $it['it_point']; ?>" id="it_point" class="frm_input form-control" size="8"> <span id="it_point_unit"><?php if($it['it_point_type']) echo '%'; else echo '점'; ?></span>
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="it_supply_point" value="<?php echo $it['it_supply_point']; ?>" id="it_supply_point" class="frm_input form-control" size="8"> 점
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="it_stock_qty" value="<?php echo $it['it_stock_qty']; ?>" id="it_stock_qty" class="frm_input form-control" size="8"> 개
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="it_noti_qty" value="<?php echo $it['it_noti_qty']; ?>" id="it_noti_qty" class="frm_input form-control" size="8"> 개
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="it_buy_min_qty" value="<?php echo $it['it_buy_min_qty']; ?>" id="it_buy_min_qty" class="frm_input form-control" size="8"> 개
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="it_buy_max_qty" value="<?php echo $it['it_buy_max_qty']; ?>" id="it_buy_max_qty" class="frm_input form-control" size="8"> 개
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<select name="it_notax" id="it_notax" class="form-control">
												...
												<div class="sit_option tbl_frm01">
													...
													<tr>
														<th scope="row">
															...
															<input type="text" name="opt1_subject" value="<?php echo $opt_subject[0]; ?>" id="opt1_subject" class="frm_input form-control" size="15">
														</th>
														<td>
															<label for="opt1"><b>옵션1 항목</b></label>
															<input type="text" name="opt1" value="" id="opt1" class="frm_input form-control" size="50">
														</td>
													</tr>
													<tr>
														<th scope="row">
															<label for="opt2_subject">옵션2</label>
															<input type="text" name="opt2_subject" value="<?php echo $opt_subject[1]; ?>" id="opt2_subject" class="frm_input form-control" size="15">
														</th>
														<td>
															<label for="opt2"><b>옵션2 항목</b></label>
															<input type="text" name="opt2" value="" id="opt2" class="frm_input form-control" size="50">
														</td>
													</tr>
													 <tr>
														<th scope="row">
															<label for="opt3_subject">옵션3</label>
															<input type="text" name="opt3_subject" value="<?php echo $opt_subject[2]; ?>" id="opt3_subject" class="frm_input form-control" size="15">
														</th>
														<td>
															<label for="opt3"><b>옵션3 항목</b></label>
															<input type="text" name="opt3" value="" id="opt3" class="frm_input form-control" size="50">
														</td>
													</tr>
													</tbody>
													</table>
													<div class="btn_confirm02 btn_confirm">
														<button type="button" id="option_table_create" class="btn_frmline btn btn-default">옵션목록생성</button>
													</div>
												</div>
											...
											<td colspan="2">
												<div id="sit_supply_frm" class="sit_option tbl_frm01">
													...
													<tr>
														<th scope="row">
															...
															<input type="text" name="spl_subject[]" id="spl_subject_<?php echo $seq; ?>" value="<?php echo $spl_subject[$i]; ?>" class="frm_input form-control" size="15">
														</th>
														<td>
															<label for="spl_item_<?php echo $seq; ?>"><b>추가<?php echo $seq; ?> 항목</b></label>
															<input type="text" name="spl[]" id="spl_item_<?php echo $seq; ?>" value="" class="frm_input form-control" size="40">
															<?php
															if($i > 0)
													...
													<div id="sit_option_addfrm_btn"><button type="button" id="add_supply_row" class="btn_frmline btn btn-default">옵션추가</button></div>
													<div class="btn_confirm02 btn_confirm">
														<button type="button" id="supply_table_create" class="btn btn-default">옵션목록생성</button>
													</div>
												</div>
												...
												$(function() {
													...
													$("#add_supply_row").click(function() {
														...
														fld += "<input type=\"text\" name=\"spl_subject[]\" value=\"\" class=\"frm_input form-control\" size=\"15\">\n";
														fld += "</th>\n";
														fld += "<td>\n";
														fld += "<label for=\"\"><b>추가 항목</b></label>\n";
														fld += "<input type=\"text\" name=\"spl[]\" value=\"\" class=\"frm_input form-control\" size=\"40\">\n";
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<select name="it_sc_type" id="it_sc_type" class="form-control">
										...
										<tr id="sc_con_method">
											...
											<td>
												<select name="it_sc_method" id="it_sc_method" class="form-control">
										...
										<tr id="sc_con_basic">
											...
											<td>
												...
												<input type="text" name="it_sc_price" value="<?php echo $it['it_sc_price']; ?>" id="it_sc_price" class="frm_input form-control" size="8"> 원
											</td>
										</tr>
										<tr id="sc_con_minimum">
											<th scope="row"><label for="it_sc_minimum">배송비 상세조건</label></th>
											<td>
												주문금액 <input type="text" name="it_sc_minimum" value="<?php echo $it['it_sc_minimum']; ?>" id="it_sc_minimum" class="frm_input form-control" size="8"> 이상 무료 배송
											</td>
										</tr>
										<tr id="sc_con_qty">
											...
											<td>
												...
												주문수량 <input type="text" name="it_sc_qty" value="<?php echo $it['it_sc_qty']; ?>" id="it_sc_qty" class="frm_input form-control" size="8"> 마다 배송비 부과
											</td>
										</tr>
									</tbody>
								</table>
								...
								<section id="anc_sitfrm_relation" class="srel">
									...
									<div class="compare_wrap">
										<section class="compare_left">
											...
											<span class="srel_pad">
												<select id="sch_relation" class="form-control">
												...
												<input type="text" name="sch_name" id="sch_name" class="frm_input form-control" size="15">
												<button type="button" id="btn_search_item" class="btn btn-default btn_frmline">검색</button>
											</span>
											...
											<div id="reg_relation" class="srel_sel">
												...
												?>
													<li>
														...
														<div class="list_item_btn"><button type="button" class="del_item btn_frmline btn btn-default">삭제</button></div>
													</li>
												<?php
													$str[] = $row['it_id'];
												}
								...
								<table id="example2" class="table table-bordered table-hover dataTable configform">
									...
									<tr>
										...
										<td class="td_extra">
											...
											<input type="text" name="it_<?php echo $i ?>_subj" id="it_<?php echo $i ?>_subj" value="<?php echo get_text($it['it_'.$i.'_subj']) ?>" class="frm_input form-control">
											<label for="it_<?php echo $i ?>">여분필드 <?php echo $i ?> 값</label>
											<input type="text" name="it_<?php echo $i ?>" value="<?php echo get_text($it['it_'.$i]) ?>" id="it_<?php echo $i ?>" class="frm_input form-control">
										</td>
										<td class="td_grpset">
