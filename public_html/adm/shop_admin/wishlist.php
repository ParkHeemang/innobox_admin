			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body">
						...
						<input type="text" name="fr_date" value="<?php echo $fr_date; ?>" id="fr_date" required class="required frm_input form-control" size="8" maxlength="8">
						~
						<label for="to_date" class="sound_only">종료일</label>
						<input type="text" name="to_date" value="<?php echo $to_date; ?>" id="to_date" required class="required frm_input form-control" size="8" maxlength="8">
