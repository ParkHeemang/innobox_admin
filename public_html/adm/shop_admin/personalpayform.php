		...
		<nav class="navbar navbar-default navbtn configform" style="z-index: 1000000000000000000000000000000000">
			<div class="nav-tabs-custom configform">
				<ul class="nav nav-tabs">                 
					<li class="active"><a href="#tab_1" data-toggle="tab">주문 정보</a></li>
					<li><a href="#tab_2" data-toggle="tab">결제 정보</a></li>				
								...
								<div class="tab-pane active" id="tab_1">
									 <table id="example2" class="table table-bordered table-hover dataTable configform">
										...
										<tr>
											...
											<td><input type="text" name="pp_name" value="<?php echo get_text($pp['pp_name']); ?>" id="pp_name" required class="required frm_input form-control"></td>
										</tr>
										<tr>
											<th scope="row"><label for="pp_price">주문금액</label></th>
											<td><input type="text" name="pp_price" value="<?php echo $pp['pp_price']; ?>" id="pp_price" required class="required frm_input form-control" size="15"> 원</td>
										</tr>
										<tr>
											<th scope="row"><label for="od_id">주문번호</label></th>
											<td><input type="text" name="od_id" value="<?php echo $pp['od_id'] ? $pp['od_id'] : ''; ?>" id="od_id" class="frm_input form-control" size="20"></td>
										</tr>
										<tr>
								...
								<div class="tab-pane" id="tab_2">
									<table id="example2" class="table table-bordered table-hover dataTable configform">
										...
										<tr>
											...
											<td><input type="text" name="pp_receipt_price" value="<?php echo $pp['pp_receipt_price'] ? $pp['pp_receipt_price'] : ''; ?>" id="pp_receipt_price" class="frm_input form-control" size="15"> 원</td>
										</tr>
										<tr>
											<th scope="row"><label for="pp_settle_case">결제방법</label></th>
											<td>
												<select name="pp_settle_case" id="pp_settle_case" class="form-control">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="pp_receipt_time" value="<?php echo is_null_time($pp['pp_receipt_time']) ? "" : $pp['pp_receipt_time']; ?>" id="pp_receipt_time" class="frm_input form-control" maxlength="19">
											</td>
										</tr>
										<?php
										...
										<tr>
											...
											<td>
												<select name="pp_use" id="pp_use" class="form-control">
