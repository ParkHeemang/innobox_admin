...
<div class="content-wrapper configform">
	<!-- Content Header (Page header) -->    
	<section class="content-header configform">
		<nav class="navbar navbar-default navbtn configform">
			<div class="nav-tabs-custom configform col-xs-12 scroll-x1">
				<!-- <div class="scroll-x2"> -->
					<ul id = "tab_ul" class="nav nav-tabs configform">
						<li class="active"><a href="#tab_1" data-toggle="tab">기본환경</a></li>
						<li><a href="#tab_2" data-toggle="tab">게시판기본</a></li>
						<li><a href="#tab_3" data-toggle="tab">회원가입</a></li>
						<li><a href="#tab_4" data-toggle="tab">본인확인</a></li>
						<li><a href="#tab_5" data-toggle="tab">기본메일환경</a></li>
						<li><a href="#tab_6" data-toggle="tab">글작성메일</a></li>
						<li><a href="#tab_7" data-toggle="tab">가입메일</a></li>
						<li><a href="#tab_8" data-toggle="tab">투표메일</a></li>
						<li><a href="#tab_9" data-toggle="tab">레이아웃 추가설정</a></li>
						<li><a href="#tab_10" data-toggle="tab">SMS</a></li>
						<li><a href="#tab_11" data-toggle="tab">여분필드</a></li>
						<!-- <li><a href="#tab_9" data-toggle="tab">테스트</a></li -->										
					</ul>					
				<!-- </div> -->
			</div>
			<div class="text-right">
			<input type="submit" value="저장" class="btn_submit btn btn-primary config_form" accesskey="s" onclick = "check_requireds()">
			</div>
		</nav>	  
	</section>
								...
								<table id="example2" class="table table-bordered table-hover dataTable config_form">
									...
									<tr>
										...
										<td>
											...
											<input type="number" name="cf_login_point" value="<?php echo $config['cf_login_point'] ?>" id="cf_login_point" required class="required frm_input" size="5"> 점
										</td>
										...
										<td>
											...
											<input type="number" name="cf_memo_send_point" value="<?php echo $config['cf_memo_send_point'] ?>" id="cf_memo_send_point" required class="required frm_input" size="5"> 점
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="cf_cut_name">이름(닉네임) 표시</label></th>
										<td colspan="3">
											<input type="number" name="cf_cut_name" value="<?php echo $config['cf_cut_name'] ?>" id="cf_cut_name" class="frm_input" size="5"> 자리만 표시
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="cf_nick_modify">닉네임 수정</label></th>
										<td>수정하면 <input type="number" name="cf_nick_modify" value="<?php echo $config['cf_nick_modify'] ?>" id="cf_nick_modify" class="frm_input" size="3"> 일 동안 바꿀 수 없음</td>
										<th scope="row"><label for="cf_open_modify">정보공개 수정</label></th>
										<td>수정하면 <input type="number" name="cf_open_modify" value="<?php echo $config['cf_open_modify'] ?>" id="cf_open_modify" class="frm_input" size="3"> 일 동안 바꿀 수 없음</td>
									</tr>
									<tr>
										<th scope="row"><label for="cf_new_del">최근게시물 삭제</label></th>
										<td>
											<?php echo help('설정일이 지난 최근게시물 자동 삭제') ?>
											<input type="number" name="cf_new_del" value="<?php echo $config['cf_new_del'] ?>" id="cf_new_del" class="frm_input" size="5"> 일
										</td>
										<th scope="row"><label for="cf_memo_del">쪽지 삭제</label></th>
										<td>
											<?php echo help('설정일이 지난 쪽지 자동 삭제') ?>
											<input type="number" name="cf_memo_del" value="<?php echo $config['cf_memo_del'] ?>" id="cf_memo_del" class="frm_input" size="5"> 일
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="number" name="cf_visit_del" value="<?php echo $config['cf_visit_del'] ?>" id="cf_visit_del" class="frm_input" size="5"> 일
										</td>
										<th scope="row"><label for="cf_popular_del">인기검색어 삭제</label></th>
										<td>
											<?php echo help('설정일이 지난 인기검색어 자동 삭제') ?>
											<input type="number" name="cf_popular_del" value="<?php echo $config['cf_popular_del'] ?>" id="cf_popular_del" class="frm_input" size="5"> 일
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="number" name="cf_login_minutes" value="<?php echo $config['cf_login_minutes'] ?>" id="cf_login_minutes" class="frm_input" size="3"> 분
										</td>
										<th scope="row"><label for="cf_new_rows">최근게시물 라인수</label></th>
										<td>
											<?php echo help('목록 한페이지당 라인수') ?>
											<input type="number" name="cf_new_rows" value="<?php echo $config['cf_new_rows'] ?>" id="cf_new_rows" class="frm_input" size="3"> 라인
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="number" name="cf_page_rows" value="<?php echo $config['cf_page_rows'] ?>" id="cf_page_rows" class="frm_input" size="3"> 라인
										</td>
										<th scope="row"><label for="cf_mobile_page_rows">모바일 한페이지당 라인수</label></th>
										<td>
											<?php echo help('모바일 목록 한페이지당 라인수') ?>
											<input type="number" name="cf_mobile_page_rows" value="<?php echo $config['cf_mobile_page_rows'] ?>" id="cf_mobile_page_rows" class="frm_input" size="3"> 라인
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="cf_write_pages">페이지 표시 수<strong class="sound_only">필수</strong></label></th>
										<td><input type="number" name="cf_write_pages" value="<?php echo $config['cf_write_pages'] ?>" id="cf_write_pages" required class="required numeric frm_input" size="3"> 페이지씩 표시</td>
										<th scope="row"><label for="cf_mobile_pages">모바일 페이지 표시 수<strong class="sound_only">필수</strong></label></th>
										<td><input type="number" name="cf_mobile_pages" value="<?php echo $config['cf_mobile_pages'] ?>" id="cf_mobile_pages" required class="required numeric frm_input" size="3"> 페이지씩 표시</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="3">
											...
											<input type="number" name="cf_point_term" value="<?php echo $config['cf_point_term']; ?>" id="cf_point_term" required class="required frm_input" size="5"> 일
										</td>
									</tr>
									<tr>
							...
							<div class="tab-pane" id="tab_2">	
								<table id="example2" class="table table-bordered table-hover dataTable config_form">
									...
									<tr>
										...
										<td><input type="number" name="cf_delay_sec" value="<?php echo $config['cf_delay_sec'] ?>" id="cf_delay_sec" required class="required numeric frm_input" size="3"> 초 지난후 가능</td>
									...
									<tr>
										...
										<td><input type="number" name="cf_read_point" value="<?php echo $config['cf_read_point'] ?>" id="cf_read_point" required class="required frm_input" size="3"> 점</td>
										<th scope="row"><label for="cf_write_point">글쓰기 포인트</label></th>
										<td><input type="number" name="cf_write_point" value="<?php echo $config['cf_write_point'] ?>" id="cf_write_point" required class="required frm_input" size="3"> 점</td>
									</tr>
									<tr>
										<th scope="row"><label for="cf_comment_point">댓글쓰기 포인트</label></th>
										<td><input type="number" name="cf_comment_point" value="<?php echo $config['cf_comment_point'] ?>" id="cf_comment_point" required class="required frm_input" size="3"> 점</td>
										<th scope="row"><label for="cf_download_point">다운로드 포인트</label></th>
										<td><input type="number" name="cf_download_point" value="<?php echo $config['cf_download_point'] ?>" id="cf_download_point" required class="required frm_input" size="3"> 점</td>
									</tr>
									<tr>
...
//config_form_update.php로부터 보낸 post값을 다시 post로 받아와서 해당 탭 열기
//input(hidden) 추가 요망
...
$(function(){
    ...
    // SMS Service
    $('#cf_sms_use').on('change', function() {
        var $this = $(this),
            value = $this.val();

        $('.sms_svc').hide();
        $('.sms_svc.sms_'+value).show();
