...
<div>
    <table id="example1" class="table table-striped table-hover dataTable board_list" width="100%">
    <thead>
    <tr>
...
?>
    ...
    <tr>
        ...
        <td class="td_mngsmall">
            ...
            <button type="button" class="add_select btn btn_03 btn-primary"><span class="sound_only"><?php echo $row['subject']; ?> </span>선택</button>
        </td>
    </tr>
...
<div class="btn_win02 btn_win">
    <button type="button" class="btn_02 btn btn-danger" onclick="window.close();">창닫기</button>
</div>
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td><input type="text" name="me_name" id="me_name" required class="frm_input form-control required"></td>
    </tr>
    <tr>
        <th scope="row"><label for="me_link">링크<strong class="sound_only"> 필수</strong></label></th>
        <td>
            <?php echo help('링크는 http://를 포함해서 입력해 주세요.'); ?>
            <input type="text" name="me_link" id="me_link" required class="frm_input form-control full_input required">
        </td>
    </tr>
    </tbody>
    </table>
...
<div class="text-center">
    <button type="button" id="add_manual" class="btn_submit btn btn-primary">추가</button>
    <button type="button" class="btn_02 btn btn-danger" onclick="window.close();">창닫기</button>
</div>
<?php } ?>