...
//CSS
add_stylesheet('<link rel="stylesheet" href="'.G5_ADMIN_URL.'/css/bootstrap.min.css?ver='.G5_CSS_VER.'">', 6);
...
function add_menu_list(name, link, code)
{
    ...
    var list = "<tr style=\"background-color:#00c0ef;\" class=\"menu_list menu_group_<?php echo $code; ?>\">";
    ...
    list += "<input type=\"text\" name=\"me_link[]\" value=\""+link+"\" id=\"me_link_"+ms+"\" required class=\"required frm_input form-control full_input\">";
    list += "</td>";
    ...
    list += "<input type=\"text\" name=\"me_order[]\" value=\"0\" id=\"me_order_"+ms+"\" required class=\"required frm_input form-control\" size=\"5\">";
    list += "</td>";
    ...
    list += "<td class=\"td_mngsmall\">";
    <?php if($new == 'new') { ?>
    list += "<button type=\"button\" class=\"btn_add_submenu btn btn-primary\">추가</button>";
    <?php } ?>
    list += "<button type=\"button\" class=\"btn_del_menu btn btn-danger\">삭제</button>";
    list += "</td>";
    list += "</tr>";
