				...
				<div class="box">
					<div class="box-header">
						<nav class="navbar navbar-default navbtn">
							<div class="text-right">							
								<a href="./boardgroup_list.php?<?php echo $qstr ?>" class="btn btn-default btn_02">목록</a>
								 <input type="submit" class="btn_submit btn btn-danger" accesskey="s" value="확인">				
							</div>
						</nav>
					</div>				
					<!-- /.box-header -->
					<div class="box-body">		
						...
						<div class="tbl_frm01 tbl_wrap">
							<table id="example2" class="table table-bordered table-hover dataTable boardgroup_form" role="grid" aria-describedby="example2_info">
							...
							<tr>
								...
								<td><input type="text" name="gr_id" value="<?php echo $group['gr_id'] ?>" id="gr_id" <?php echo $gr_id_attr; ?> class="<?php echo $gr_id_attr; ?> alnum_ frm_input form-control" maxlength="10">
									<?php
									if ($w=='')
							...
							<tr>
								...
								<td>
									<input type="text" name="gr_subject" value="<?php echo get_text($group['gr_subject']) ?>" id="gr_subject" required class="required frm_input form-control" size="80">
									<?php
									if ($w == 'u')
							...
							<tr>
								...
								<td>
									...
									<select id="gr_device" name="gr_device" class="form-control">
