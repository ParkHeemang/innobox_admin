		...
		<nav class="navbar navbar-default navbtn configform">
			<div class="nav-tabs-custom configform">
				<ul class="nav nav-tabs">                 
					<li class="active"><a href="#tab_1" data-toggle="tab">기본설정</a></li>
					<li><a href="#tab_2" data-toggle="tab">권한설정</a></li>
					<li><a href="#tab_3" data-toggle="tab">기능설정</a></li>
					<li><a href="#tab_4" data-toggle="tab">디자인/양식</a></li>
					<li><a href="#tab_5" data-toggle="tab">포인트 설정</a></li>
					<li><a href="#tab_6" data-toggle="tab">여분필드</a></li>
					<li class="pull-right config_form"><input type="submit" value="확인" class="btn_submit btn btn-primary btn-xs config_form" accesskey="s"></li>
				</ul>
			</div>
		</nav>
	</section>
					...
					<div class="box-body">				
						...
						<div class="tab-content">				
							<div class="tab-pane active" id="tab_1">
								<table id="example2" class="table table-bordered table-hover dataTable board_form">
									...
									<tr>
										...
										<td colspan="2">
											<input type="text" name="bo_table" value="<?php echo $board['bo_table'] ?>" id="bo_table" <?php echo $required ?> <?php echo $readonly ?> class="frm_input form-control <?php echo $reaonly ?> <?php echo $required ?> <?php echo $required_valid ?>" maxlength="20">
											<?php if ($w == '') { ?>
									...
									<tr>
										...
										<td colspan="2">
											<input type="text" name="bo_subject" value="<?php echo get_text($board['bo_subject']) ?>" id="bo_subject" required class="required frm_input form-control" size="80" maxlength="120">
										</td>
									</tr>
									<tr>
										...
										<td colspan="2">
											...
											<input type="text" name="bo_mobile_subject" value="<?php echo get_text($board['bo_mobile_subject']) ?>" id="bo_mobile_subject" class="frm_input form-control" size="80" maxlength="120">
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="bo_category_list" value="<?php echo get_text($board['bo_category_list']) ?>" id="bo_category_list" class="frm_input form-control" size="70">
							...
							<div class="tab-pane" id="tab_2">
								<table id="example2" class="table table-bordered table-hover dataTable board_form">
									...
									<tr>
										...
										<td>
											<input type="text" name="bo_admin" value="<?php echo $board['bo_admin'] ?>" id="bo_admin" class="frm_input form-control" maxlength="20">
										</td>
										<td class="td_grpset">
									...
									<table id="example2" class="table table-bordered table-hover dataTable board_form">
										...
										<tr>
											...
											<td>
												...
												댓글 <input type="text" name="bo_count_modify" value="<?php echo $board['bo_count_modify'] ?>" id="bo_count_modify" required class="required numeric frm_input form-control" size="3">개 이상 달리면 수정불가
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												댓글 <input type="text" name="bo_count_delete" value="<?php echo $board['bo_count_delete'] ?>" id="bo_count_delete" required class="required numeric frm_input form-control" size="3">개 이상 달리면 삭제불가
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="bo_upload_count" value="<?php echo $board['bo_upload_count'] ?>" id="bo_upload_count" required class="required numeric frm_input form-control" size="4">
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												업로드 파일 한개당 <input type="text" name="bo_upload_size" value="<?php echo $board['bo_upload_size'] ?>" id="bo_upload_size" required class="required numeric frm_input form-control"  size="10"> bytes 이하
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="bo_write_min" value="<?php echo $board['bo_write_min'] ?>" id="bo_write_min" class="numeric frm_input form-control" size="4">
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="bo_write_max" value="<?php echo $board['bo_write_max'] ?>" id="bo_write_max" class="numeric frm_input form-control" size="4">
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="bo_comment_min" value="<?php echo $board['bo_comment_min'] ?>" id="bo_comment_min" class="numeric frm_input form-control" size="4">
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="bo_comment_max" value="<?php echo $board['bo_comment_max'] ?>" id="bo_comment_max" class="numeric frm_input form-control" size="4">
											</td>
											<td class="td_grpset">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="bo_order" value="<?php echo $board['bo_order'] ?>" id="bo_order" class="frm_input form-control" size="4">
											</td>
											<td class="td_grpset">
							...
							<div class="tab-pane" id="tab_4">
								<table id="example2" class="table table-bordered table-hover dataTable board_form">
									...
									<tr>
										...
										<td>
											<input type="text" name="bo_include_head" value="<?php echo $board['bo_include_head'] ?>" id="bo_include_head" class="frm_input form-control" size="50">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											<input type="text" name="bo_include_tail" value="<?php echo $board['bo_include_tail'] ?>" id="bo_include_tail" class="frm_input form-control" size="50">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="bo_subject_len" value="<?php echo $board['bo_subject_len'] ?>" id="bo_subject_len" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											<?php echo help('목록에서의 제목 글자수. 잘리는 글은 … 로 표시') ?>
											<input type="text" name="bo_mobile_subject_len" value="<?php echo $board['bo_mobile_subject_len'] ?>" id="bo_mobile_subject_len" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											<input type="text" name="bo_page_rows" value="<?php echo $board['bo_page_rows'] ?>" id="bo_page_rows" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											<input type="text" name="bo_mobile_page_rows" value="<?php echo $board['bo_mobile_page_rows'] ?>" id="bo_mobile_page_rows" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="bo_gallery_width" value="<?php echo $board['bo_gallery_width'] ?>" id="bo_gallery_width" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="bo_gallery_height" value="<?php echo $board['bo_gallery_height'] ?>" id="bo_gallery_height" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="bo_mobile_gallery_width" value="<?php echo $board['bo_mobile_gallery_width'] ?>" id="bo_mobile_gallery_width" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="bo_mobile_gallery_height" value="<?php echo $board['bo_mobile_gallery_height'] ?>" id="bo_mobile_gallery_height" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="bo_table_width" value="<?php echo $board['bo_table_width'] ?>" id="bo_table_width" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="bo_image_width" value="<?php echo $board['bo_image_width'] ?>" id="bo_image_width" required class="required numeric frm_input form-control" size="4"> 픽셀
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="bo_new" value="<?php echo $board['bo_new'] ?>" id="bo_new" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											...
											<input type="text" name="bo_hot" value="<?php echo $board['bo_hot'] ?>" id="bo_hot" required class="required numeric frm_input form-control" size="4">
										</td>
										<td class="td_grpset">
							...
							<div class="tab-pane" id="tab_5">
								<table id="example2" class="table table-bordered table-hover dataTable board_form">
									...
									<tr>
										...
										<td>
											<input type="text" name="bo_read_point" value="<?php echo $board['bo_read_point'] ?>" id="bo_read_point" required class="required frm_input form-control" size="5">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											<input type="text" name="bo_write_point" value="<?php echo $board['bo_write_point'] ?>" id="bo_write_point" required class="required frm_input form-control" size="5">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											<input type="text" name="bo_comment_point" value="<?php echo $board['bo_comment_point'] ?>" id="bo_comment_point" required class="required frm_input form-control" size="5">
										</td>
										<td class="td_grpset">
									...
									<tr>
										...
										<td>
											<input type="text" name="bo_download_point" value="<?php echo $board['bo_download_point'] ?>" id="bo_download_point" required class="required frm_input form-control" size="5">
										</td>
										<td class="td_grpset">
								...
								<table id="example2" class="table table-bordered table-hover dataTable board_form">
									...
									<tr>
										...
										<td class="td_extra">
											...
											<input type="text" name="bo_<?php echo $i ?>_subj" id="bo_<?php echo $i ?>_subj" value="<?php echo get_text($board['bo_'.$i.'_subj']) ?>" class="frm_input form-control">
											<label for="bo_<?php echo $i ?>">여분필드 <?php echo $i ?> 값</label>
											<input type="text" name="bo_<?php echo $i ?>" value="<?php echo get_text($board['bo_'.$i]) ?>" id="bo_<?php echo $i ?>" class="frm_input form-control">
										</td>
										<td class="td_grpset">
...
required_elements = document.getElementById("fboardform").querySelectorAll("[required]");
