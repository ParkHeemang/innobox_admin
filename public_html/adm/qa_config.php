					...
					<div class="box-body">								
						...
						<section id="anc_cf_qa_config">
							...
							<div class="tbl_frm01 tbl_wrap">
								<table id="example2" class="table table-bordered table-hover dataTable qa_config" role="grid" aria-describedby="example2_info">
								...
								<tr>
									...
									<td>
										<input type="text" name="qa_title" value="<?php echo $qaconfig['qa_title'] ?>" id="qa_title" required class="required tbl_input form-control" size="40">
										<a href="<?php echo G5_BBS_URL; ?>/qalist.php" class="btn_frmline btn btn-default">1:1문의 바로가기</a>
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<input type="text" name="qa_category" value="<?php echo $qaconfig['qa_category'] ?>" id="qa_category" required class="required tbl_input form-control" size="70">
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="qa_skin">스킨 디렉토리<strong class="sound_only">필수</strong></label></th>
									<td>
										<?php echo get_skin_select('qa', 'qa_skin', 'qa_skin', $qaconfig['qa_skin'], 'required class="form-control"'); ?>
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="qa_mobile_skin">모바일 스킨 디렉토리<strong class="sound_only">필수</strong></label></th>
									<td>
										<?php echo get_mobile_skin_select('qa', 'qa_mobile_skin', 'qa_mobile_skin', $qaconfig['qa_mobile_skin'], 'required class="form-control"'); ?>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										...
										<select name="qa_use_sms" id="qa_use_sms"class="form-control">
								...
								<tr>
									...
									<td>
										...
										<input type="text" name="qa_send_number" value="<?php echo $qaconfig['qa_send_number'] ?>" id="qa_send_number" class="tbl_input form-control"  size="30">
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<input type="text" name="qa_admin_hp" value="<?php echo $qaconfig['qa_admin_hp'] ?>" id="qa_admin_hp" class="tbl_input form-control"  size="30">
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<input type="text" name="qa_admin_email" value="<?php echo $qaconfig['qa_admin_email'] ?>" id="qa_admin_email" class="tbl_input form-control"  size="50">
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<select name="qa_use_editor" id="qa_use_editor" class="form-control">
								...
								<tr>
									...
									<td>
										...
										<input type="text" name="qa_subject_len" value="<?php echo $qaconfig['qa_subject_len'] ?>" id="qa_subject_len" required class="required numeric tbl_input form-control"  size="4">
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php echo help('목록에서의 제목 글자수') ?>
										<input type="text" name="qa_mobile_subject_len" value="<?php echo $qaconfig['qa_mobile_subject_len'] ?>" id="qa_mobile_subject_len" required class="required numeric tbl_input form-control"  size="4">
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="qa_page_rows">페이지당 목록 수<strong class="sound_only"> 필수</strong></label></th>
									<td>
										<input type="text" name="qa_page_rows" value="<?php echo $qaconfig['qa_page_rows'] ?>" id="qa_page_rows" required class="required numeric tbl_input form-control"  size="4">
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="qa_mobile_page_rows">모바일 페이지당 목록 수<strong class="sound_only"> 필수</strong></label></th>
									<td>
										<input type="text" name="qa_mobile_page_rows" value="<?php echo $qaconfig['qa_mobile_page_rows'] ?>" id="qa_mobile_page_rows" required class="required numeric tbl_input form-control"  size="4">
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<input type="text" name="qa_image_width" value="<?php echo $qaconfig['qa_image_width'] ?>" id="qa_image_width" required class="required numeric tbl_input form-control"  size="4"> 픽셀
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										업로드 파일 한개당 <input type="text" name="qa_upload_size" value="<?php echo $qaconfig['qa_upload_size'] ?>" id="qa_upload_size" required class="required numeric tbl_input form-control"  size="10"> bytes 이하
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="qa_include_head">상단 파일 경로</label></th>
									<td>
										<input type="text" name="qa_include_head" value="<?php echo $qaconfig['qa_include_head'] ?>" id="qa_include_head" class="tbl_input form-control" size="50">
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="qa_include_tail">하단 파일 경로</label></th>
									<td>
										<input type="text" name="qa_include_tail" value="<?php echo $qaconfig['qa_include_tail'] ?>" id="qa_include_tail" class="tbl_input form-control" size="50">
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="td_extra">
										...
										<input type="text" name="qa_<?php echo $i ?>_subj" id="qa_<?php echo $i ?>_subj" value="<?php echo get_text($qaconfig['qa_'.$i.'_subj']) ?>" class="tbl_input form-control">
										<label for="qa_<?php echo $i ?>">여분필드 <?php echo $i ?> 값</label>
										<input type="text" name="qa_<?php echo $i ?>" value="<?php echo get_text($qaconfig['qa_'.$i]) ?>" id="qa_<?php echo $i ?>" class="tbl_input form-control">
									</td>
								</tr>
								<?php } ?>
								</tbody>
