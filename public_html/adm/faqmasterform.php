					...
					<div class="box-header">
						<nav class="navbar navbar-default navbtn">
							<div class="text-right">							
								<a href="./faqmasterlist.php" class="btn btn-default btn_02">목록</a>
					...
					<div class="box-body">
						...
						<div class="tbl_frm01 tbl_wrap">
							...
							<tr>
								...
								<td>
									<input type="text" value="<?php echo get_text($fm['fm_subject']); ?>" name="fm_subject" id="fm_subject" required class="frm_input form-control required"  size="70">
									<?php if ($w == 'u') { ?>
