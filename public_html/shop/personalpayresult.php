...
// 테마에 personalpayresult.php 있으면 include
if(defined('G5_THEME_SHOP_PATH')) {
    $theme_personalpayresult_file = G5_THEME_SHOP_PATH.'/personalpayresult.php';
    if(is_file($theme_personalpayresult_file)) {
        include_once($theme_personalpayresult_file);
        return;
        unset($theme_personalpayresult_file);
    }
}
