...
// 테마에 order_complete.php 있으면 include
if(defined('G5_THEME_SHOP_PATH')) {
    $theme_complete_file = G5_THEME_SHOP_PATH.'/ordercomplete.php';
    if(is_file($theme_complete_file)) {
        include_once($theme_complete_file);
        return;
        unset($theme_complete_file);
    }
}
        ...
        <div class="tbl_head02 tbl_wrap">
            <table>
                ...
                <tbody>
                    <tr>
                        <th>사이트명</th>
                        <td><?php echo $od['od_productname']?></td>
                    </tr>
                    <tr>
                        <th>가격</th>
                        <td><?php echo number_format($od['od_price']);?>원</td>
                    </tr>
                </tbody>
            </table>
        </div>
