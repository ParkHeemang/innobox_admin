...
<script>var itemlist_ca_id = "<?php echo $ca_id; ?>";</script>
...
<div id="sct">
    ...
    if (file_exists($skin_file)) {
        // 카테고리에 포함된 상품 갯수
        $cait = sql_fetch(" select count(*) as cnt from {$g5['g5_shop_item_table']} where it_use='1' and left(ca_id,".strlen($ca_id).")='$ca_id' ");
        echo '<div id="sct_totalcnt"><u>'.$ca['ca_name'].'</u> 총 <b>'.number_format($cait['cnt']).'</b>개의 상품이 등록되어 있습니다.</div>';
