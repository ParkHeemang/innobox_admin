...
$refund_price = 0; // 환불금액 PG 결제 취소에 사용 2017-10-17

// PG 결제 취소
if($od['od_tno']) {
    $refund_price = $od['od_receipt_price']; 
    switch($od['od_pg']) {
        case 'lg':
...
// 입금금액은 그대로 남겨둠 2017-10-17
// 사용자 취소는 전체 취소임
// 신용카드 결제 취소는 입금금액을 환불금액에 넣어줌
$sql = " update {$g5['g5_shop_order_table']}
            set od_send_cost = '0',
                od_send_cost2 = '0',
                od_misu = '0',
                od_cancel_price = '$cancel_price',
                od_refund_price = '$refund_price',
                od_cart_coupon = '0',
                od_coupon = '0',
                od_send_coupon = '0',
                od_status = '취소',
