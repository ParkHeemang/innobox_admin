...
// 테마에 itemrecommend.php 있으면 include
if(defined('G5_THEME_SHOP_PATH')) {
    $theme_itemrecommend_file = G5_THEME_SHOP_PATH.'/itemrecommend.php';
    if(is_file($theme_itemrecommend_file)) {
        include_once($theme_itemrecommend_file);
        return;
        unset($theme_itemrecommend_file);
    }
}
