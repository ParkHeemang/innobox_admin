...
// 테마에 personalpay.php 있으면 include
if(defined('G5_THEME_SHOP_PATH')) {
    $theme_personalpay_file = G5_THEME_SHOP_PATH.'/personalpay.php';
    if(is_file($theme_personalpay_file)) {
        include_once($theme_personalpay_file);
        return;
        unset($theme_personalpay_file);
    }
}
